$(function() {
    ...
    $('.start-initial-video').on('click', function() {
        $('.initial-video-area')
            .append('<iframe id="yt01" src="//www.youtube.com/embed/leD9srixeiw?rel=0&amp;showinfo=0&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>');
        $('.initial-video-area')
            .find('.iframe-img')
            .fadeOut('fast');
        $(this)
    ...
    $('.start-midia-video').on('click', function() {
        $('.midia-video-area')
            .append('<iframe id="yt02" src="//www.youtube.com/embed/rkH6CzFQMgc?rel=0&amp;showinfo=0&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>');
        $('.midia-video-area')
            .find('.iframe-img')
            .fadeOut('fast');
        $(this)
